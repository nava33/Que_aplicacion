import 'package:nava/screen/CallScreen.dart';
import 'package:nava/screen/CameraScreen.dart';
import 'package:nava/screen/ChatScreen.dart';
import 'package:nava/screen/StatusScreen.dart';
          ...
          onPressed: () {
            return showDialog(
                ...
                builder: (BuildContext context) {
                  return AlertDialog(
                    title: Text("Contacto"),
                    content: Text("Desarrollado por Eliseo Nava"),
                    elevation: 24.0,
                    ...
                    actions: <Widget>[
                      ...
                      FlatButton(
                        child: Text("Github"),
                        onPressed: () {
                          _launchURL("https://github.com/nava33/");
                        },
                      ),
                    ],
                  );
